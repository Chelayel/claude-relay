...
class ChatWebView(parent: Disposable) : ChatView {
    ...
    companion object {
        private val CLAUDE_SVG = """
            <svg viewBox='0 0 16 16' fill='none'><g stroke='#fff' stroke-width='1.6' stroke-linecap='round' stroke-linejoin='round'>
            <polyline points='4.5,4 8.5,8 4.5,12'/><polyline points='8,4 12,8 8,12'/></g></svg>
        """.trimIndent()
